...
int main(int argc, char** argv)
{
    ...
    {"hadamard_non_square_correct", []() -> bool {
        gl::texture::texture_set_t		textures;
    ...
    {"hadamard_square_counter_correct", []() -> bool {
        gl::texture::texture_set_t		textures;
    ...
    { "non_square_mult_counter_correct", []() -> bool {
        gl::texture::texture_set_t		textures;
